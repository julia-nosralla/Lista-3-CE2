...
- Ao fazer uma requisição, os dados geralemente retornam em arquivos no formato JSON (Java Script Object Notation)
...
- Inicialmente, para mostrar de forma mais didática as etapas do processo de requisição, utilizaremos uma API pública sem chave que disponibiliza as informações de todos os pokemons. 
