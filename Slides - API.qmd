...
url <- str_c("https://api.openweathermap.org/geo/1.0/direct?q=Brasília&appid=", key)
...
url2 <- str_c("https://api.openweathermap.org/data/2.5/weather?lat=", latitude, "&lon=", longitude, "&appid=", key, "&units=metric") #Por default, esta API retorna a temperatura em                                             Kelvin. Para obter a temperatura em Celsius,                                               utilizamos o parâmetro "units=metric"
...
# Site com várias API's públicas {background-image="background.jpg"}
...
-   <https://blog.platformbuilders.io/o-que-sao-apis/>
-   <https://aws.amazon.com/pt/compare/the-difference-between-json-xml/> -<https://blog.betrybe.com/json/>
